...
image_icon = PhotoImage(file="lastfm.png")
root.iconphoto(False, image_icon)

frameCnt = 30
frames = [PhotoImage(file='mus.gif',format = 'gif -index %i' %(i)) for i in range(frameCnt)]
...
Label(root,image= Menu).place(x=0, y=500, width=485, height=80)
